...
def test_sub():
    assert calculator.calculate(5, 2, 'subtract') == 3

def test_sub_2():
    assert calculator.calculate(400, 142, 'subtract') == 258

def test_multiply():
    assert calculator.calculate(5, 2, 'multiply') == 10

def test_divid():
    assert calculator.calculate(20, 5, 'divide') == 4
